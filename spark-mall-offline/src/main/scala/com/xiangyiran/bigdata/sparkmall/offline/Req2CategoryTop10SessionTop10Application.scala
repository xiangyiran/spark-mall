package com.xiangyiran.bigdata.sparkmall.offline

import java.sql.{Connection, DriverManager, PreparedStatement}
import java.util.UUID

import com.xiangyiran.bigdata.sparkmall.model.UserVisitAction
import com.xiangyiran.bigdata.sparkmall.util.{ConfigUtil, StringUtil}
