package com.xiangyiran.bigdata.sparkmall.realtime

import com.xiangyiran.bigdata.sparkmall.model.MyKafkaMessage
import com.xiangyiran.bigdata.sparkmall.util.{DateUtil, MykafkaUtil, RedisUtil}
