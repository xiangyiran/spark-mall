package com.xiangyiran.bigdata.sparkmall.mock

import java.text.SimpleDateFormat
import java.util.UUID

import com.xiangyiran.bigdata.sparkmall.model.{CityInfo, ProductInfo, UserInfo, UserVisitAction}
import com.xiangyiran.bigdata.sparkmall.util.{RanOpt, RandomDate, RandomNum, RandomOptions}
